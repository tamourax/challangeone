import 'package:challangeone/Features/transaction_details/presentation/view/widgets/custom_button.dart';
        ...
        Container(
          ...
          child: const Column(
            ...
            children: [
             ...
             RowDetailsWidget(title: 'Transfer Amount',trailling: r'$520',),
             SizedBox(height: 16,),
             UserInfoDetails(),
             SizedBox(height: 12,),
             RowDetailsWidget(title: 'Data & time',trailling: '1 Jan 2023, 10:30PM',),
             SizedBox(height: 12,),
             RowDetailsWidget(title: 'No. Ref',trailling: '11288889058722',),
             SizedBox(height: 32,)
            ],
          ),
        )
